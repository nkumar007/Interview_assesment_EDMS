(async function () {
  ...
  editEmployee.addEventListener("click", () => {
    ...
    for (const field of addEmployeeForm.elements) {
      if (field.name in editValues) {
        field.value = editValues[field.name];
      }
    }
  });
  ...
  const renderEmployees = () => {
    ...
    employees.forEach((emp) => {
      ...
      employee.innerHTML = `<div><span>${emp.firstName} ${emp.lastName}</span> </div> <i class="employeeDelete">❌</i> `;
